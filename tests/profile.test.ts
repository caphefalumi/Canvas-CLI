...
describe('Profile Display', () => {
  test('profile table renders field-value pairs', () => {
    ...
    const table = new Table(columns, { showRowNumbers: false, title: 'User Profile' });
  ...
  test('profile table handles long values', () => {
    ...
    table.addRow({
      field: 'Bio',
      value: 'This is a very long biography that exceeds the column width and should be truncated with ellipsis'
    });
