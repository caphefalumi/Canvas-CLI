...
describe('Display - Narrow Terminal Tests', () => {
  test('table fits in 60-column terminal', () => {
    ...
    table.addRow({ name: 'Very Long Assignment Name That Needs Truncation', due: '12/20/2025' });
  ...
  test('table with 4 columns fits in 80-column terminal', () => {
    ...
    const table = new Table(columns, { showRowNumbers: true });
    table.addRow({ id: '1', name: 'Week2: ACF Lab 3: Advanced Computer Forensics', type: 'pdf', status: '✓ Submitted' });
...
describe('Display - Wide Terminal Tests', () => {
  test('table expands properly in wide terminal', () => {
    ...
    table.addRow({ name: 'This is a really long assignment name that needs lots of space to display properly', due: '12/20/2025' });
...
describe('Display - Edge Case Tests', () => {
  ...
  test('many rows table', () => {
    ...
    const columns = [
      { key: 'name', header: 'Item', flex: 1, minWidth: 10 }
    ];
  ...
  test('very long cell content gets truncated', () => {
    ...
    const table = new Table(columns, { showRowNumbers: false });
    table.addRow({ text: 'This is an extremely long text that definitely needs to be truncated because it exceeds the column width by a significant amount' });
  ...
  test('table with title in narrow terminal', () => {
    ...
    const table = new Table(columns, { showRowNumbers: false, title: 'My Table' });
